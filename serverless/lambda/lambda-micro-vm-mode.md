### Lambda Micro VM Mode

Lambda MicroVM — serverless-среда выполнения для запуска пользовательского кода в изолированных, сохраняющих состояние execution environments. В основе используется Firecracker microVM, обеспечивающая VM-уровень изоляции при быстром запуске.
